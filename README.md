...
> 因为脑图原件是.mmap格式（如果你买了mindmanager（想买激活码的也可以找我要，ps：15RMB/份，永久无限制）可以找我要mmap原文件- -
![](https://simonhu1993.github.io/images/xianyu2019.png)），使用wps和xmind打开都会有格式不兼容的问题，这里我们可以使用mindmanager存为html5交互式格式，
